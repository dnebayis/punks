...
function makeBaseHead(s: { light: string; dark: string; nose: string }, shirtColor: string): Pixel[] {
  ...
  return [
    ...
    p(8,8,O), p(9,8,L), p(10,8,O), p(11,8,L), p(12,8,O), p(13,8,L), p(14,8,O), p(15,8,O),
    p(7,9,O), p(8,9,L), p(9,9,O), p(10,9,L), p(11,9,O), p(12,9,L), p(13,9,O), p(14,9,L), p(15,9,O), p(16,9,O),
    p(7,10,O), p(8,10,L), p(9,10,O), p(10,10,L), p(11,10,O), p(12,10,L), p(13,10,O), p(14,10,L), p(15,10,O), p(16,10,O),
    p(7,11,O), p(8,11,L), p(9,11,L), p(10,11,L), p(11,11,L), p(12,11,L), p(13,11,L), p(14,11,L), p(15,11,L), p(16,11,O),
    p(6,12,O), p(7,12,L), p(8,12,L), p(9,12,D), p(10,12,D), p(11,12,L), p(12,12,L), p(13,12,L), p(14,12,D), p(15,12,D), p(16,12,O),
    p(6,13,O), p(7,13,L), p(8,13,L), p(9,13,O), p(10,13,N), p(11,13,L), p(12,13,L), p(13,13,L), p(14,13,O), p(15,13,N), p(16,13,O),
...
function makeEyes(i: number): { px: Pixel[]; n: string } {
  ...
  const e: Record<number, { px: Pixel[]; n: string }> = {
    0: {
      px: [
        p(9,9,W), p(10,9,W), p(13,9,W), p(14,9,W),
        p(9,10,W), p(10,10,W), p(13,10,W), p(14,10,W),
      ],
      n: "Big Eyes",
    },
    1: {
      px: [
        p(9,9,W), p(10,9,W), p(13,9,W), p(14,9,W),
        p(9,10,O), p(10,10,O), p(13,10,O), p(14,10,O),
      ],
      n: "Dot Eyes",
    },
    2: {
    ...
    3: {
      px: [
        p(9,9,"#27ae60"), p(10,9,"#27ae60"),
        p(9,10,"#27ae60"), p(10,10,"#27ae60"),
        p(13,9,"#27ae60"), p(14,9,"#27ae60"),
        p(13,10,"#27ae60"), p(14,10,"#27ae60"),
      ],
      n: "Green Eyes",
    },
    4: {
      px: [
        ...
        p(9,10,"#e74c3c"), p(10,10,"#e74c3c"),
        p(13,9,"#e74c3c"), p(14,9,"#e74c3c"),
        p(13,10,"#e74c3c"), p(14,10,"#e74c3c"),
      ],
      n: "Red Eyes",
    },
    5: {
...
function makeFacialHair(i: number): { px: Pixel[]; n: string } {
  const b: Record<number, { px: Pixel[]; n: string }> = {
    ...
    4: {
      px: [
        p(9,13,"#1a1a2e"), p(10,13,"#1a1a2e"),
        p(13,13,"#1a1a2e"), p(14,13,"#1a1a2e"),
        p(10,14,"#1a1a2e"), p(13,14,"#1a1a2e"),
      ],
      n: "Mustache",
    },
    5: {
      px: [
        p(9,13,"#c4a035"), p(10,13,"#c4a035"),
        p(13,13,"#c4a035"), p(14,13,"#c4a035"),
        p(8,12,"#c4a035"), p(15,12,"#c4a035"),
        p(10,14,"#c4a035"), p(13,14,"#c4a035"),
      ],
      n: "Handlebars",
    },
    6: {
